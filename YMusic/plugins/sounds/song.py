...
"""
    ...
    async def download_and_send_audio(client, message, pablo, sedlyf, urlissed, ytdl_data):
        ...
        try:
            ...
            await pablo.edit(f"**حدث خطأ أثناء إرسال الملف الصوتي**\n**خطأ :** `{str(e)}`")
    ...
    await download_and_send_audio(client, message, pablo, sedlyf, urlissed, ytdl_data)
